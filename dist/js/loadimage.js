...
var AsyncImage = /*#__PURE__*/function () {
  function AsyncImage(elem, opts) {
  ...
  _createClass(AsyncImage, null, [{
    key: "add",
    value: function () {
      var _add = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(obj) {
    ...
    key: "initWorker",
    value: function () {
      var _initWorker = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                if (!(AsyncImage.queue.length > 0)) {
                  _context2.next = 5;
                  break;
                }
                _context2.next = 3;
                return AsyncImage.process();
              case 3:
                _context2.next = 0;
                break;
              case 5:
...
_defineProperty(AsyncImage, "queue", []);
_defineProperty(AsyncImage, "workers", 0);
_defineProperty(AsyncImage, "show", {
  error: function error(elem) {
    $(elem).find('.status').html('<div class="error"><div /></div>');
  },
  loading: function loading(elem) {
    $(elem).find('.status').html('<div class="spinner"><div /></div>');
  },
  image: function image(elem, src) {
